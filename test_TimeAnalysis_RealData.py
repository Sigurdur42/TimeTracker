...
class TimeAnalysisWithRealDataTests(unittest.TestCase):
    ...
    def __verify_day(
            ...
            expected_overtime_minutes: int):
        wanted_day = [_ for _ in self.target.data_by_day if _.scope.strftime("%d.%m.%Y") == day][0]
        self.assertEqual(expected_minutes, wanted_day.working_seconds / 60, f'Wrong working duration on {day}')
        self.assertEqual(expected_overtime_minutes, wanted_day.overtime_seconds / 60,
